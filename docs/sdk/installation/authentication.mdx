...
<Note> 
**Security Note:** Never generate or store private RSA keys within the mobile application. Ensure that JWT generation is performed on the server side to maintain security.
</Note>
