...
### 1. [Authenticate (`Authenticate`)](/docs/ios-sdk/sdk/installation/authentication)
...
### 2. [Initialize (`Initialize`)](/docs/ios-sdk/sdk/installation/initialize)
...
### 3. [Issue a Digital Card (`IssueCard`)](/docs/ios-sdk/sdk/installation/issue-card)
...
### 4. [Add Card to Wallet (`Add to Wallet`)](/docs/ios-sdk/sdk/installation/add-to-wallet)
To enable "Tap & Go," the card must be provisioned (tokenized) to a wallet. For **iOS**, users must use the "Add to Apple Wallet" flow to push the token to their iPhone or Apple Watch.
