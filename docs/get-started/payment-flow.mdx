...
Once the card is set up, the user goes through this flow every time they buy something. This uses "Tap & Go" technology (NFC) to make paying at a store as easy as touching the phone to the reader.
