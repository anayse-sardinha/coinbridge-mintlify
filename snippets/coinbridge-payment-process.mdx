...
### 3. Create a Digital Card (`IssueCard`)
...
### 4. Add Card to Wallet (`Add to Wallet`)
...
### 2. Tap the Device
The user holds their device near the merchant's EMV terminal.
